...
console.log('All environment variables:', Object.keys(process.env).filter(key => key.startsWith('EXPO_PUBLIC')));
...
if (!supabaseUrl || !supabaseAnonKey) {
  ...
  console.error('❌ After adding .env file, restart the development server with: npm run dev');
}
